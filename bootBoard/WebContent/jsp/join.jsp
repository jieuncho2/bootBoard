				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item active" href="join.jsp">회원가입
							<span class="sr-only0">(current)</span>
						</a>
					</div>
				</li>
			</ul>
					...
					<form method="post" action="loginAction.jsp">
						...
						<div class="form-group">
							<label class="btn btn-primary active">
								<input class="d-none" type="radio" name="userGender" autocomplete="off" value="남자" checked="checked"/>
								남자
							</label>
							<label class="btn btn-primary">
								<input class="d-none" type="radio" name="userGender" autocomplete="off" value="여자" checked="checked"/>
								여자
							</label>
						</div>
						<div class="form-group">
